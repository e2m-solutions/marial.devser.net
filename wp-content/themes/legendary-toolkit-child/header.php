 ...
 */
    ...
    $content_container = (toolkit_get_sidebar_selection() || is_page_template('blank-page.php')  || is_page_template('page-templates/home-page-template.php') || is_page_template('page-full-width.php') ||  is_page_template('page-templates/home-template.php') ||  is_page_template('page-templates/about-template.php') || is_archive() || is_single() || is_home()) ? 'container-fluid' : 'container';
?> 
<!DOCTYPE html>
